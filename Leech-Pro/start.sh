...
wget -O aria2/dht.dat https://github.com/P3TERX/aria2.conf/raw/master/dht.dat
wget -O aria2/dht6.dat https://github.com/P3TERX/aria2.conf/raw/master/dht6.dat
