...
TG_BOT_TOKEN = "5520490506:AAGJZ6R8PZeJVD8nP7YzRyuoshqO9paM6Ck" #os.environ.get("TG_BOT_TOKEN", "")
APP_ID = 9891195 #int(os.environ.get("APP_ID", "12345"))
API_HASH = "42c8bd9c3416e8270086bd69ba0000ac" #os.environ.get("API_HASH")
OWNER_ID = 890079399 #int(os.environ.get("OWNER_ID", "539295917"))

# Get these values from my.telegram.org
# to store the channel ID who are authorized to use the bot
AUTH_CHANNEL = [-691697833]# [int(x) for x in os.environ.get("AUTH_CHANNEL", "539295917").split()]
